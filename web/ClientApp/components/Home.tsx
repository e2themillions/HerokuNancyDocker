...
export default class Home extends React.Component<RouteComponentProps<{}>, {}> {
    public render() {
        return <div>
            <h1>Allo mundo!</h1>
            <p>Welcome to the new .NET Core 2+Nancy+Docker+Heroku SPA, built with:</p>
            <ul>
                <li><a href='https://nancyfx.org'>Nancy (.Net Core 2 - Clint Eastwood edition)</a></li>
            ...
            <ul>
                <li><strong>Docker Container</strong>. For easy deployment to e.g. Heroku</li>
            ...
            <p>
                <em><strong>From: <a href="https://github.com/e2themillions/HerokuNancyDocker">github.com/e2themillions/HerokuNancyDocker</a></strong> with ❤ based on the <a href="https://docs.microsoft.com/en-us/aspnet/core/client-side/spa/react-with-redux?view=aspnetcore-2.1">Microsoft .Net Core 2.1 web project template with React and Redux.</a></em>
            </p>
        </div>;
    }
}
